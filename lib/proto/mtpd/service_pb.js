...
goog.exportSymbol('proto.mtpd.Label', null, global);
 ...
 * @constructor
 */
proto.mtpd.Label = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.mtpd.Label, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.mtpd.Label.displayName = 'proto.mtpd.Label';
}
 ...
 * @return {!Object}
 */
proto.mtpd.Label.prototype.toObject = function(opt_includeInstance) {
  return proto.mtpd.Label.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.mtpd.Label} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mtpd.Label.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.mtpd.Label}
 */
proto.mtpd.Label.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.mtpd.Label;
  return proto.mtpd.Label.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.mtpd.Label} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.mtpd.Label}
 */
proto.mtpd.Label.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.mtpd.Label.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.mtpd.Label.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.mtpd.Label} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mtpd.Label.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getKey();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.mtpd.Label.prototype.getKey = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.mtpd.Label.prototype.setKey = function(value) {
 ...
 * @return {string}
 */
proto.mtpd.Label.prototype.getValue = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.mtpd.Label.prototype.setValue = function(value) {
...
proto.mtpd.Device = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.mtpd.Device.repeatedFields_, null);
};
 ...
 * @const
 */
proto.mtpd.Device.repeatedFields_ = [7];
...
proto.mtpd.Device.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.mtpd.Label.toObject, includeInstance)
  };
...
proto.mtpd.Device.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      ...
      break;
    case 7:
      var value = new proto.mtpd.Label;
      reader.readMessage(value,proto.mtpd.Label.deserializeBinaryFromReader);
      msg.addLabels(value);
      break;
    default:
      reader.skipField();
...
proto.mtpd.Device.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      7,
      f,
      proto.mtpd.Label.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.mtpd.Label>}
 */
proto.mtpd.Device.prototype.getLabelsList = function() {
  return /** @type{!Array<!proto.mtpd.Label>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.mtpd.Label, 7));
};


/** @param {!Array<!proto.mtpd.Label>} value */
proto.mtpd.Device.prototype.setLabelsList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 7, value);
};


/**
 * @param {!proto.mtpd.Label=} opt_value
 * @param {number=} opt_index
 * @return {!proto.mtpd.Label}
 */
proto.mtpd.Device.prototype.addLabels = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 7, opt_value, proto.mtpd.Label, opt_index);
};


proto.mtpd.Device.prototype.clearLabelsList = function() {
  this.setLabelsList([]);
};
