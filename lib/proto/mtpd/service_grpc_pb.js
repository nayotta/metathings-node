...
var mtpd_service_pb = require('../mtpd/service_pb.js');

function serialize_mtpd_ListDevicesByApplicationRequest(arg) {
  if (!(arg instanceof mtpd_service_pb.ListDevicesByApplicationRequest)) {
...
function deserialize_mtpd_ListDevicesByApplicationRequest(buffer_arg) {
  return mtpd_service_pb.ListDevicesByApplicationRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_mtpd_ListDevicesByApplicationResponse(arg) {
  if (!(arg instanceof mtpd_service_pb.ListDevicesByApplicationResponse)) {
...
function deserialize_mtpd_ListDevicesByApplicationResponse(buffer_arg) {
  return mtpd_service_pb.ListDevicesByApplicationResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var MetaPlatformSrvService = exports.MetaPlatformSrvService = {
  listDevicesByApplication: {
    ...
    requestType: mtpd_service_pb.ListDevicesByApplicationRequest,
    responseType: mtpd_service_pb.ListDevicesByApplicationResponse,
